...
<html lang="en">
<head>
    <title>Code coverage report for stream.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> stream.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>222/223</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L509'></a><a href='#L509'>509</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
function formatError(error: mixed): Error {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof error === 'object' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >error != null </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >error.message != null)</span> {
<span class="cstat-no" title="statement not covered" >        return new Error(error.message);</span>
    }
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Mon Jun 17 2019 15:12:06 GMT+0200 (Central European Summer Time)
</div>
</div>
