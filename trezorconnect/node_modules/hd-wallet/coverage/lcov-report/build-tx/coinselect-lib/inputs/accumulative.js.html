...
<html lang="en">
<head>
    <title>Code coverage report for build-tx/coinselect-lib/inputs/accumulative.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">build-tx/coinselect-lib/inputs</a> accumulative.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
            ...
            const outAccumWithFee = outAccum.isNaN()
                ? <span class="branch-0 cbranch-no" title="branch not covered" >new BigNumber(0) </span>: outAccum.plus(new BigNumber(fee));
&nbsp;
            // go again?
