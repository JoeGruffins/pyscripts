...
<html lang="en">
<head>
    <title>Code coverage report for build-tx/coinselect-lib/utils.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">build-tx/coinselect-lib</a> utils.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2023x</span>
...
export function bigIntOrNaN(v): BigInteger | NaN {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (v instanceof BigInteger) return v;
...
export function bignumberOrNaN(v): BigNumber {
    ...
    try {
        ...
        return value.toFixed() === v ? value : <span class="branch-1 cbranch-no" title="branch not covered" >new BigNumber(NaN);</span>
    } catch (error) {
...
export function sumOrNaN(range, forgiving = false): BigNumber {
    return range.reduce((a, x) =&gt; {
        ...
        if (value.isNaN()) return forgiving ? new BigNumber(0) : new BigNumber(NaN);
        return value.plus(a);
    }, new BigNumber(0));
}
&nbsp;
