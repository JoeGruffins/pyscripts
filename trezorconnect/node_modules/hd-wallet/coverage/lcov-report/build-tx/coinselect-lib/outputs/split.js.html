...
<html lang="en">
<head>
    <title>Code coverage report for build-tx/coinselect-lib/outputs/split.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">build-tx/coinselect-lib/outputs</a> split.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    if (!outputs.every(x =&gt; x.value !== undefined
        || (
            splitValue.comparedTo(new BigNumber(dustThreshold)) &gt; 0
        ))) return FEE_RESPONSE;
&nbsp;
