...
<html lang="en">
<head>
    <title>Code coverage report for coinselect-lib/tryconfirmed.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">coinselect-lib</a> tryconfirmed.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">function filterCoinbase(utxos, minConfCoinbase) {
...
&nbsp;
    return (utxosO, outputs, feeRate, optionsIn) =&gt; {
        utxosO.forEach((utxo) =&gt; {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (utxo.coinbase == null || utxo.own == null || utxo.confirmations == null) {
